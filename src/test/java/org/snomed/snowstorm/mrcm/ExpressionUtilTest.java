...
class ExpressionUtilTest {
	...
	void testInvalidEcl() {
		Assertions.assertThrows(IllegalStateException.class, () -> {
			String invalidRule = "<< 71388002 |Procedure (procedure)|: [0..*] { [0..*] 405815000 |Procedure device| = << 49062001 |Device (physical object)| }" + ", << 363787002 |Observable entity (observable entity)|: [0..*] { [0..1] 405815000 |Procedure device| = << 49062001 |Device (physical object)| }";
			ExpressionUtil.sortExpressionConstraintByConceptId(invalidRule);
		});
	}

	@Test
	void testConstraintWithWildcard() {
	...
	@Test
	void testRefinedExpressionConstraint() {
	...
	@Test
	void testRefinedConstraintWithDisjunctions() {
